# Graph-Theory-Sketcher
Final project for CPT_S/MATH 453 at Washington State University
...
The user will be able to select any 2 nodes, and see the shortest path between the 2.

### Bipartite-ness - Status: Planned
The user will be able to see if the graph is bipartite or not.

### Tree-ness - Status: Planned
The user will be able to see if the graph is a tree.

### Dual Graphs - Status: Stretch Goal
The user will be able to click a button that will open a new tab with the dual graph of the current tab.

### Physics - Status: Stretch Goal
The user will be able to toggle physics on, which will rearrange the graph into a physics-based object.